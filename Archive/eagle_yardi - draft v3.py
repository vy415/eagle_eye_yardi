...
def main():
	...
	parser.add_argument('-p', '--prop_name', action='store_true', default=False, help='Extact the cell containing the property name.')
	parser.add_argument('--header_row', action='store_true', default=False, help='Extact the header_row cells.')
